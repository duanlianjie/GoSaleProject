...
//连接信息
const MQURL = "amqp://root:123456@localhost:5672/vhost1"
...
//simple 模式消费者
func (r *RabbitMQ) ConsumeSimple(orderService services.OrderService, productService services.ProductService) {
	//1.申请队列，如果队列不存在会自动创建，存在则跳过创建
