...
var localHost = ""
//数量控制接口服务器内网IP，或者 getOne 的SLB内网IP
var GetOneIp = "127.0.0.1"
var GetOnePort = "8084"
var port = "8083"
var hashConsistent *commons.Consistent
//rabbitmq
...
func CheckUserInfo(r *http.Request) error {
	...
	//对信息进行解密
	signByte, err := encrypt.DecodePassword(signCookie.Value)
	if err != nil {
...
func main() {
	//负载均衡器设置
	//采用一致性哈希算法
	hashConsistent = commons.NewConsistent()
	//采用一致性hash算法，添加节点
	for _, v := range hostArray {
		hashConsistent.Add(v)
	}

	localIP, err := commons.GetInstanceIP()
	if err != nil {
		fmt.Println(err)
	}
	localHost = localIP
